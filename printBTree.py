# printBTree.ty
#
# print binary trees on cosole
#
# Supports any class or structure without inheritance
#
# Example output:
#
#              80
...
# usage:
#
#     printBTree(RootNode, getNodeInfo, inverted=True/False)
#
#     RootNode is an object instance which will be the top of the tree
#     getNodeInfo is a function or lambda that takes a node parameter and
#     must return a tuple with 3 values: (Label,LeftNode,RightNode)
#
#         Label is the text to print for the current node
#         LeftNode is the left side child of the current node (or None)
#         RightNode is the right side child of the current node (or None)
...
# Print a binary tree stored in a list as a heap tree
#
#  e.g. family = [ "Me","Paul","Rosa","Vincent","Jody","John","Kate"]
